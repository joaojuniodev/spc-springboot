...
public class CatechistSummaryDTO {

    private Long id;
    private String firstName;
    private String lastName;

    public CatechistSummaryDTO() {}

    public CatechistSummaryDTO(Long id, String firstName, String lastName) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        CatechistSummaryDTO that = (CatechistSummaryDTO) o;
